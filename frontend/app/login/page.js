...
import login_image from "@/public/assets/login_image.jpg";
export default function Login() {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-900 text-white">
            <div className="flex">
                <div className="p-8 bg-gray-800 rounded-l-2xl shadow-2xl border border-gray-700 w-200">
                    <Image src={login_image} alt="login_image"
                        width={200}
                        height={200}
                        className="rounded-lg w-full h-full" />
                </div>
                <div className="w-full max-w-md p-8 bg-gray-800 rounded-r-2xl shadow-2xl border border-gray-700">
